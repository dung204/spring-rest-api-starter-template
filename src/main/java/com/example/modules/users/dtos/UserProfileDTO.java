...
public class UserProfileDTO extends EntityDTO {
  ...
  @Schema(description = "The first name of the user", example = SwaggerExamples.FIRST_NAME, nullable = true)
  private String firstName;

  @Schema(description = "The last name of the user", example = SwaggerExamples.LAST_NAME, nullable = true)
